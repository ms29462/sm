...
export const api = {
  ...
  getOpportunitiesCount: (filters = {}) => axios.get(`${API}/opportunities/count`, { params: filters, headers: getAuthHeaders() }),
  getOpportunityFilters: () => axios.get(`${API}/opportunities/filters`, { headers: getAuthHeaders() }),
  getOpportunities: (page = 1, limit = 5, filters = {}) => axios.get(`${API}/opportunities`, { params: { page, limit, ...filters }, headers: getAuthHeaders() }),
  ...
  sendRepresentationRequest: (data) => axios.post(`${API}/representation-requests`, data, { headers: getAuthHeaders() }),
  getRepresentationRequests: () => axios.get(`${API}/representation-requests/my`, { headers: getAuthHeaders() }),
  respondRepresentationRequest: (id, status) => axios.put(`${API}/representation-requests/${id}/respond`, { status }, { headers: getAuthHeaders() }),
  ...
  createAcademyCheckout: (pack_id) => axios.post(`${API}/stripe/create-academy-checkout`, { pack_id }, { headers: getAuthHeaders() }),
