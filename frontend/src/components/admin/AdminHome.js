    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div data-testid="stat-applications" className="bg-card border border-border/50 p-6 rounded-sm">
          ...
          <h3 className="text-sm font-medium uppercase tracking-wide text-muted-foreground">TOTAL APPLICATIONS</h3>
        </div>
      ...
      <div className="mt-8 bg-card border border-border/50 p-8 rounded-sm">
        ...
        <p className="text-muted-foreground mb-6">
          Use the navigation menu to manage players, clubs, and opportunities. You can approve or reject accounts, delete users, and moderate content.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div className="bg-background p-4 rounded-sm border border-border">
            ...
            <p className="text-muted-foreground">Moderate posted opportunities and remove inappropriate content</p>
          </div>
        </div>
      </div>
    </div>
