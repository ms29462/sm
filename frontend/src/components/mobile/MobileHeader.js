...
const NAV_LINKS = {
  ...
  federation: [
    ...
    { to: '/federation/players', label: 'Browse Players' },
    { to: '/federation/recommended', label: 'Recommended' },
    { to: '/federation/scouting', label: 'Scouting Hub' },
    { to: '/federation/teams', label: 'Team Groups' },
    { to: '/federation/favorites', label: 'Favorites' },
    { to: '/federation/opportunities', label: 'Opportunities' },
    { to: '/federation/applications', label: 'Applications' },
    { to: '/federation/pipeline', label: 'Pipeline' },
  ...
  analyst: [
    ...
    { to: '/analyst/players', label: 'Players to Evaluate' },
    { to: '/analyst/browse', label: 'Browse Players' },
