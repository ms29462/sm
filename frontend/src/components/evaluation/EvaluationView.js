          ...
          <Tabs defaultValue="summary" className="w-full">
            ...
            <TabsContent value="tactical" className="mt-4">
              {evaluation.tactical_analysis ? (
                <p className="text-sm text-muted-foreground whitespace-pre-line">{evaluation.tactical_analysis}</p>
              ) : (
            ...
            <TabsContent value="physical" className="mt-4">
              {evaluation.physical_analysis ? (
                <p className="text-sm text-muted-foreground whitespace-pre-line">{evaluation.physical_analysis}</p>
              ) : (
            ...
            <TabsContent value="mental" className="mt-4">
              {evaluation.mental_analysis ? (
                <p className="text-sm text-muted-foreground whitespace-pre-line">{evaluation.mental_analysis}</p>
              ) : (
