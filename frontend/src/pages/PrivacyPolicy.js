    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">2. Data We Collect</h2>
            ...
            <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
              ...
              <li>Application history and messages</li>
              <li>IP address and browser data (for security purposes)</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">3. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">4. Data Retention</h2>
            <p className="text-muted-foreground">We retain your personal data for as long as your account is active. You may request deletion of your account and all associated data at any time by contacting us at contact@soccermatch.ca.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">5. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">6. Your Rights (GDPR & Law 25)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">7. Cookies</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">8. Security</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">9. Contact & Complaints</h2>
          ...
          <section>
            <h2 className="text-lg font-bold uppercase mb-3 text-primary">10. Changes to This Policy</h2>
