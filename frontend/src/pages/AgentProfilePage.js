...
import { User, MapPin, Star, Globe, ArrowLeft, Briefcase, Award, Languages, CheckCircle } from 'lucide-react';
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {agent.license_number && (
                <span className="inline-flex items-center gap-1 text-xs bg-primary/10 text-primary border border-primary/20 px-3 py-1 rounded-sm">
                  <CheckCircle className="w-3 h-3" /> Licensed — {agent.license_number}
                </span>
              )}
